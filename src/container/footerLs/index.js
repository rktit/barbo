		...
		<ScrollableAnchor id="footer">
			<Content className="row">
				<div className='box px-10'>
					<div className='offset-1 p-2 content'>
						<div className="row p-4 text-white">
								...
								<div className="col-3">
									...
									<div className='d-flex'>
										<div className='d-flex grid'>
											...
											<Fade right><div className='conteudo col-2'><a href='https://pt-br.facebook.com/barboempreendimentos/' target="_blank"><img src={ico_face} alt='Facebook' className='icone_midia' /></a></div></Fade>
							...
							<div className='col-2 p-2 info'>
								...
								<Fade>
									<div className='contexto pt-3 infos'>
							...
							<div className='col-2 p-2 info'>
								<Fade>
									...
									<div className='contexto'>
										<a onClick={() => clickMenu("/trabalhe-conosco")} href="/trabalhe-conosco" id="btn-trab">Loteamento</a>
									</div>
									<div className='contexto'>
										<a onClick={() => clickMenu("/trabalhe-conosco")} href="/trabalhe-conosco" id="btn-trab">Residencial</a>
									</div>
									<div className='contexto'>
										<a onClick={() => clickMenu("/trabalhe-conosco")} href="/trabalhe-conosco" id="btn-trab">Corporativo</a>
									</div>
								</Fade>
							</div>
							<div className='col-2 p-2 info'>
